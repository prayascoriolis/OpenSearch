...
public class ThreadPool implements ReportingService<ThreadPoolInfo>, Scheduler {
    ...
    public static final Setting<Integer> TRANSLOG_TRANSFER_THREAD_MIN = Setting.intSetting("thread_pool.translog_transfer.min", 1, 1, Setting.Property.NodeScope);
    public static final Setting<Integer> TRANSLOG_TRANSFER_THREAD_MAX = Setting.intSetting("thread_pool.translog_transfer.max", halfAllocatedProcessors(OpenSearchExecutors.allocatedProcessors(Settings.EMPTY)), 1, Setting.Property.NodeScope);
    public static final Setting<TimeValue> TRANSLOG_TRANSFER_KEEP_ALIVE = Setting.timeSetting("thread_pool.translog_transfer.keep_alive", TimeValue.timeValueMinutes(5), Setting.Property.NodeScope);
